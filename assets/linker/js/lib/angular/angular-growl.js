...
angular.module('angular-growl').directive('growl', [
  ...
  function ($rootScope) {
    ...
    return {
      restrict: 'A',
      template: '<div class="growl">' + '\t<div class="growl-item ui message" ng-repeat="message in messages" ng-class="computeClasses(message)">' + '\t\t<i class="close icon" ng-click="deleteMessage(message)"></i>' + '       <div ng-switch="message.enableHtml">' + '           <div ng-switch-when="true" ng-bind-html="message.text"></div>' + '           <div ng-switch-default ng-bind="message.text"></div>' + '       </div>' + '\t</div>' + '</div>',
      replace: false,
      scope: true,
      controller: [
        '$scope',
